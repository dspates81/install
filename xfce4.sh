...
#other
#sudo pacman -S --needed arc-gtk-theme arc-icon-theme arj code cpio extra-cmake-modules kde-cli-tools kdiff3 kdoctools keditbookmarks kompare konsole kparts krusader lhasa p7zip unace unrar unzip vlc xz zip gvfs gvfs-smb edk2-ovmf vde2 nss-mdns
